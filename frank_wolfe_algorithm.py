...
@jit
def frank_wolfe_algorithm(phi_big_oracle, phi_small_solver, primal_dual_oracle,
    ...
    for counter in range(1, max_iter):
        ...
        if counter == 1:
            ...
            #epsilon_absolute = epsilon * dist_solution_init
                
        if dist_solution < epsilon_absolute:
            result = {'times': times,
                      'flows': flows,
                      'iter_num':counter,
                      'res_msg': 'success',
